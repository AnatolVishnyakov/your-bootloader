...
public class Utils {
    ...
    private static final String USER_AGENT_TPL = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/%s Safari/537.36";
    ...
    public static String randomChromeVersion() {
        int ind = ThreadLocalRandom.current().nextInt(CHROME_VERSIONS.length);
        return CHROME_VERSIONS[ind];
    }
